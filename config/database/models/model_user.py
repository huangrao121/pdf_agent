...
if TYPE_CHECKING:
    from .model_document import DocsModel, NoteModel, ChatSessionModel, JobModel
    from .model_auth import OAuthIdentityModel, PasswordCredentialModel, VerificationCodeModel
