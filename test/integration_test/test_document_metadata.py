...
@pytest.mark.asyncio
async def test_get_document_metadata_success(test_app, db_session, test_user, test_workspace, test_document):
...
@pytest.mark.asyncio
async def test_get_document_metadata_with_etag(test_app, db_session, test_user, test_workspace, test_document):
...
@pytest.mark.asyncio
async def test_get_document_metadata_not_found(test_app, db_session, test_user, test_workspace):
...
@pytest.mark.asyncio
async def test_get_document_metadata_forbidden(test_app, db_session, test_user, test_document):
...
@pytest.mark.asyncio
async def test_get_document_metadata_different_workspace(test_app, db_session, test_user, test_workspace, test_document):
...
@pytest.mark.asyncio
async def test_get_document_metadata_with_null_fields(test_app, db_session, test_user, test_workspace):
...
@pytest.mark.asyncio
async def test_get_document_metadata_failed_status(test_app, db_session, test_user, test_workspace):
...
@pytest.mark.asyncio
async def test_get_document_metadata_etag_changes_on_update(test_app, db_session, test_user, test_workspace, test_document):
